...
const StickyNote = ({ img, name }) => {
  return (
    <div class='trackbox' style={{margin: '1rem 1rem 3rem 1rem', position: 'relative', padding: '10%', boxSizing: 'border-box'}}>
      <img
        src={note_tape}
        alt=""
        style={{
      ...
      <div style={{position: 'absolute', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', width: '100%', left: '0%', top: '0%'}} >
        <img src={img} alt="waffle stack" style={{height: '100%', maxWidth: '70%', maxHeight: '60%'}} />
