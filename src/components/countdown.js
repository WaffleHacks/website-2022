...
const mapNumber = (number, inMin, inMax, outMin, outMax) => (number - inMin) * (outMax - outMin) / (inMax - inMin) + outMin;
...
const Countdown = ({ time }) => {
  ...
  useEffect(() => {
    const ticker = setInterval(() => {
      ...
      const difference = endpoint.diffNow(['days', 'hours', 'minutes', 'seconds']);
  ...
  // TODO: fix days radius being weird
