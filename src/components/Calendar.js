...
let events = [
    ...
    [ 1, 14, "Hacker Icebreakers with MLH", 3, "Need a break from hacking? Join our MLH coach, Ellie Popoca, for a game of Slideshow Karaoke!" ],
