...
const Tracks = () => {
  return (
    <center id='tracks'>
        ...
        <StickyNote img={stethoscope} name="Healthcare" desc="This hack is open-ended, and we encourage you to think about ways to boost people's health either mentally or physically!" />
