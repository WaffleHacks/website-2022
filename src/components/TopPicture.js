...
const TopPicture = () => {
  ...
  return (
    <div id='cafearea' style={divStyles}>
        ...
        <span style={{position: 'absolute', display: !musicTilt  ? 'none' : '', fontSize: '1.7vw', left: '13.5vw', top: '16vw', transform: 'translate(-50%, -50%)'}}>01100011<br />01101000<br />01100001<br />01101100<br />01101011</span>
